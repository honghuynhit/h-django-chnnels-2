"""
Django settings for django_notifications_project project.
...
SECRET_KEY = 'qtss4j54^0dm*$nu@&uswz#)*muq00cj%svrqz2w$q02d#_s2+'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['139.180.205.6', 'huynhga.com']
...
WSGI_APPLICATION = 'django_notifications_project.wsgi.application'
...
CHANNEL_LAYERS = {
    "default": {
        ...
        "CONFIG": {
            "host": "amqp://admin:StrongPassword@1270.0.0.1/",
        },
    },
}
